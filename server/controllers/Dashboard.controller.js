...
export const HandleHRDashboard = async (req, res) => {
    try {
        ...
        return res.status(200).json({ success: true, data: { employees: employees, departments: departments, leaves: leaves, requests: requests, balance: balance, notices: notices } })
    }
    catch (error) {
